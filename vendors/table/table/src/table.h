/*----------------------------------------------------------------------
  ...
  History : 06.03.1996 file created
            ...
            29.11.1998 functions tpl_clone, tab_clone, tab_fill added
            ...
            03.04.1999 parameter 'cloneas' added to function tab_clone
            ...
            17.01.2007 tab_colnorm returns offset and scaling factor
            18.01.2007 tab_coltlin, tab_coltype, tpl_coltype added
----------------------------------------------------------------------*/
#ifndef __TABLE__
#define __TABLE__
#include "fntypes.h"
...
extern TUPLE*  tpl_clone   (TUPLE *tpl);
...
extern int     tpl_coltype (TUPLE *tpl, int colid);
...
extern int     tpl_nullcnt (const TUPLE *tpl);
...
extern void    tab_fill    (TABLE *tab, int tploff, int tplcnt,
...
extern void    tab_colnorm (TABLE *tab, int colid,
                            double exp, double sdev,
                            double *pscl, double *poff);
extern void    tab_coltlin (TABLE *tab, int colid,
...
extern int     tab_coltype (TABLE *tab, int colid);
...
#define tpl_coltype(t,i)   att_type(tpl_col(t, i))
